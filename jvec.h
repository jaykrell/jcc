...
#define JVEC(T) struct { T* data; size_t size, capacity; }
...
int jvec_insert(jvec_generic*, void* before, void* begin, size_t count, size_t element_size);

#define JVEC_RESIZE(v, size)        jvec_resize((jvec_generic*)(v), size, sizeof((v)->data[0]))
