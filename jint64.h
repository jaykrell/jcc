...
typedef long jint64, jint64_t, INT64;
typedef unsigned long juint64, juint64_t, UINT64;
#define JINT64_PRI "l"

/* Clear indication from gcc predefines that long long works. */
#elif __LONG_LONG_WIDTH__ == 64
typedef long long jint64, jint64_t, INT64;
typedef unsigned long long juint64, juint64_t, UINT64;
...
typedef __int64 jint64, jint64_t, INT64;
typedef unsigned __int64 juint64, juint64_t, UINT64;
